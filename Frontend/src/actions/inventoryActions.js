...
export const PostInventory = (TotalPacket_Cartoon, Price) => dispatch => {
    var inventoryData = {'Id':id,
        'TotalPacket_Cartoon': TotalPacket_Cartoon, 'Price': parseInt(Price)
    }
    
    const postInventory = fetch(ROOT_URL+'/inventory/', {
        method: 'POST',
...
export const deleteInventory = (inventoryId) => dispatch => {
    const postInventory = fetch(ROOT_URL+'/inventory'+inventoryId, {
        method: 'DELETE',
        headers: {
...
export const updateInventory = (inventoryId, TotalPacket_Cartoon, Price) => dispatch => {
    var prodData = {'inventoryId':inventoryId,
        'TotalPacket_Cartoon': TotalPacket_Cartoon, 'Price': parseInt(Price), 
    }
