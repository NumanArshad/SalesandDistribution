...
var rolePrivilege={'RoleName':RoleName,'distId':parseInt(DistributorId),
'selectedPrivileges':SelectedPrivilege}
alert(SelectedPrivilege.length)
fetch('https://localhost:44377/api/Privileges/AssignPrivilege', {
        method: 'POST',
...
export const GetRolePrivileges=(DistributorId)=>dispatch=>{
    ...
    fetch('https://localhost:44377/api/Privileges/'+DistributorId, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
            mode: 'cors',
          //  body: JSON.stringify(rolePrivilege)
...
export const FetchRolesbyDistributor=(DistributorId)=>dispatch=>{
    ...
    fetch('https://localhost:44377/api/Users/RolebyDistributor', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
            mode: 'cors',
            body: JSON.stringify(rolePrivilege)
    ...
    export const AssignUsertoRole = (userDetail,DistId) => dispatch => {
       ...
       // )
        ...
        fetch('https://localhost:44377/api/Users/CreateUser', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
            mode: 'cors',
    ...
    export const GetUsertoRole = (DistId) => dispatch => {
      ...
      //  )
        ...
        fetch('https://localhost:44377/api/Users/GetUser', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
            mode: 'cors',
            body: JSON.stringify(user)
    ...
    export const DeleteUsertoRole = (UserId,DistId) => dispatch => {
      //  alert(DistId+"in api before delete hit"
       // )
        ...
        fetch('https://localhost:44377/api/Users/DeleteUser', {
            method: 'DELETE',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
            mode: 'cors',
            body: JSON.stringify(user)
    ...
    export const GetUsertoRolebyId = (UserId) => dispatch => {
       // alert(UserId+"in api get specific before get hit")
        ...
        fetch('https://localhost:44377/api/Users/'+UserId, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
            mode: 'cors',
           // body: JSON.stringify(user)
    ...
    //    alert(DistId+"in api before delete hit"
      //  )
        ...
        fetch('https://localhost:44377/api/Users/'+userObj.UserId, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
            mode: 'cors',
            body: JSON.stringify(user)
