...
export const signUpDistributor = (disDetail) => dispatch => {
    var distributor = {
        'FirstName': disDetail.FirstName,
        "LastName": disDetail.LastName,
        "Email": disDetail.Email,
        "Contact": disDetail.Contact,
        "Address": disDetail.Address,
        "Province": disDetail.Province,
        "City": disDetail.City,
        "PostalCode": parseInt(disDetail.PostalCode),
        "Country": disDetail.Country,
