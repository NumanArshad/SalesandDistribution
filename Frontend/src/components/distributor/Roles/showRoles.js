...
const headRows = [
  { label: ' Role', numeric: false, disablePadding: true, id: 'Numan' },
  //  { label: 'Last Name', numeric: true, disablePadding: false, id: 'Arshad' },
  { label: 'Privilege', numeric: true, disablePadding: false, id: 'numanuet311@gmail.com' },
...
const useStyles = makeStyles(theme => ({
 ...
 function ShowRole(props) {
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, props.rolePrivilegesList.length - page * rowsPerPage);
  ...
  return (
        ...
        <div className={classes.tableWrapper}>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={props.rolePrivilegesList.length}
            />
            <TableBody>
              {stableSort(props.rolePrivilegesList, getSorting(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.privilege.name}</TableCell>
    ...
    }><div><EditIcon  onClick={()=>props.GetPrivilegesofSpecificRole(props.userId,row.role.id)}
    ...
    style={{marginLeft:10,cursor:'pointer'}} /></div>
        ...
        <TablePagination
          ...
          component="div"
          count={props.rolePrivilegesList.length}
